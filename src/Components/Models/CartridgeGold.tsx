 ...
 * @constructor
 */
export default function CartridgeGold({ ...props }: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>(null!)
  const { nodes, materials } = useGLTF('/assets/models/zloty/cartridge zloty.gltf') as GLTFResult
...
useGLTF.preload('/assets/models/zloty/cartridge zloty.gltf')
