 ...
 * @constructor
 */
export default function CartridgeSilver({ ...props }: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>(null!)
  const { nodes, materials } = useGLTF('/assets/models/szary/cartridge szary.gltf') as GLTFResult
  return (
...
useGLTF.preload('/assets/models/szary/cartridge szary.gltf')
